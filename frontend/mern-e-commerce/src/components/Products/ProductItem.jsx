    ...
    <div className="product-item glide__slide glide__slide--active">
      <div className="product-image">
        <a href="#" draggable="true">
          {/* <img src={productItem.img.singleImage} alt="" className="img1" /> data.jsondan kurtulduk artık alttaki gibi fetch edip modeldeki bilgileri bu şekilde alacağız */}
      ...
      <div className="product-info">
        ...
        <div className="product-prices">
          <strong className="new-price">
            {/* ${productItem.price.newPrice.toFixed(2)} fetch öncesi */}$
